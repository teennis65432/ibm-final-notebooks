...
for i, n in spacex_df.groupby('Launch Site'):
    print(n)
    options.append({'label': n['Launch Site'].unique(), 'value':(str(i))})
...
def get_scatter(dropdown, slider):
    print(slider)
    if dropdown == 'ALL':
        ...
        filtered = spacex_df[spacex_df['Launch Site']==dropdown]
